...
urlpatterns = [
    ...
    re_path( r'^info/$', views.info, name='info_url' ),

    re_path( r'^login/$', views.login, name='login_url' ),
    re_path( r'^logout/$', views.logout, name='logout_url' ),
    re_path( r'^shib_login/$', views.handle_shib_login, name='shib_login_url' ),
    re_path( r'^user_pass_handler/$', views.user_pass_handler, name='user_pass_handler_url' ),

    re_path( r'^browse/$', views.browse_tabulator, name='browse_url' ),
    re_path( r'^browse_logout/$', views.browse_logout, name='browse_logout_url' ),
    ...
    re_path( r'^editor/records/$', views.edit_record, name='edit_record_url' ),
    re_path( r'^editor/records/(?P<rec_id>.*)/$', views.edit_record_w_recid, name='edit_record_w_recid_url' ),

    re_path( r'^editor/person/$', views.edit_person, name='edit_person_root_url' ),
    re_path( r'^editor/person/(?P<rfrnt_id>.*)/$', views.edit_person, name='edit_person_url' ),
    re_path( r'^editor/$', views.editor_index, name='editor_index_url' ),
    ...
    re_path( r'^search_results/$', views.search_results, name='search_results_url' ),

    re_path( r'^map/$', views.map, name='map_url' ),
    re_path( r'^timeline/$', views.timeline, name='timeline_url' ),

    re_path( r'^unify/$', views.unify, name='unify_url' ),

    # --------------------
    # redesign...
    # --------------------

    re_path( r'^redesign_home/$', views.redesign_home, name='redesign_home_url' ),
    re_path( r'^redesign_citations/$', views.redesign_citations, name='redesign_citations_url' ),
    re_path( r'^redesign_citations/(?P<cite_id>.*)/$', views.redesign_citation, name='redesign_citation_url' ),


    ## apis...

    re_path( r'^data/documents/$', views.data_documents, name='data_documents_url' ),
    re_path( r'^data/documents/(?P<doc_id>.*)/$', views.data_documents, name='data_documents_url' ),

    re_path( r'^data/records/$', views.data_records, name='data_record_url' ),  # note, 'refID' is passed on a PUT.
    ...
    re_path( r'^data/relationships/$', views.data_relationships, name='data_relationships_url' ),
    ...
    re_path( r'^data/$', views.data_root, name='data_root_url' ),  # a 'fake' url, for building other urls; set to return a 404 if hit directly


    ## utility-urls (protected, act as viewable integrity checks)...

    re_path( r'^utility/citations/$', views.utility_citations, name='utility_citations_url' ),
    # url( r'^utility/items/$', views.utility_items, name='utility_items_url' ),
    re_path( r'^utility/referents/$', views.utility_referents, name='utility_referents_url' ),
    ...
    re_path( r'^datafile/$', views.datafile, name='datafile_url' ),
    ...
    re_path( r'^error_check/$', views.error_check, name='error_check_url' ),

    # url( r'^$', RedirectView.as_view(pattern_name='browse_url') ),
    re_path( r'^$', RedirectView.as_view(pattern_name='info_url') ),
